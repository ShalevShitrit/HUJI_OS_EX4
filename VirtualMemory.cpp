...
uint64_t handle_page_fault(int level, uint64_t& cur_address, uint64_t& target_frame ,
...
void dfs(uint64_t parent_address, uint64_t base_address, word_t &max_frame,uint64_t max_distance,int cur_distance,int level,
    bool found_empty)
{
